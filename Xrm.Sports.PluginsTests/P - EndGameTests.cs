...
namespace Xrm.Sports.Plugins.Tests
{
    ...
    public class EndGameTests
    {
        ...
        public void Tie()
        {
            ...
            var game3 = new Entity("jvmp_game");
            game3.Id = Guid.NewGuid();
            game3["jvmp_name"] = "January 15th - Maple Leafs vs Canadiens";
            game3["jmvp_hometeam"] = new EntityReference(team2.LogicalName, team2.Id);
            game3["jmvp_awayteam"] = new EntityReference(team1.LogicalName, team1.Id);
            game3["jmvp_outcome"] = new OptionSetValue(492470002);

            fakedContext.Initialize(new List<Entity>()
            {
                team1, team2, game1, game2,game3
            });
            ...
            ParameterCollection inputParameters = new ParameterCollection();
            inputParameters.Add("Target", game3);
            ...
            Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual(((int)team1["jmvp_tierecord"] + 1), (int)updatedAwayTeam["jmvp_tierecord"]);
            Microsoft.VisualStudio.TestTools.UnitTesting.Assert.AreEqual(((int)team2["jmvp_tierecord"] + 1), (int)updatedHomeTeam["jmvp_tierecord"]);
